...
SWIFT_EXTERN void net_nfet_printing_set_document(uint32_t job, uint8_t const * _Nullable doc, uint64_t size) SWIFT_NOEXCEPT;

SWIFT_EXTERN void net_nfet_printing_set_error(uint32_t job, char const * _Nullable message) SWIFT_NOEXCEPT;
