...
extension Foundation.Bundle {
    ...
    static let module: Bundle = {
        let bundleName = "flutter_secure_storage_darwin_flutter_secure_storage_darwin"
        ...
        fatalError("unable to find bundle named flutter_secure_storage_darwin_flutter_secure_storage_darwin")
    }()
}