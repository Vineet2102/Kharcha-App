...
void main() {
  ...
  setUp(() {
    ...
    when(() => auth.onAuthStateChange).thenAnswer((_) => Stream<AuthState>.empty());
  });

  testWidgets('signed-out user is redirected to /login (Gate 3, T-3.4)', (tester) async {
  ...
  testWidgets('signed-in user boots straight to the dashboard placeholder (Gate 2/3)', (tester) async {
    final user = User(
      id: 'u1',
      appMetadata: const {},
      userMetadata: const {},
